...
def plotTrapsheet(ts, pinfo):
    ...
    fig.savefig(CFG.TRAPSHEET.IMAGE_TRAPESHEET, facecolor=facecolor)
...
# trapfolder = 'C:/temp'
p = Path(str(CFG.TRAPSHEET.FOLDER_LOCATION))


# print('Latest path: ', latest_path)

trapfile = getRecentTrapsheet(CFG.TRAPSHEET.FOLDER_LOCATION)
...
print(
    "Grade: ", ts["Grade"], " Points: ", ts["Points"][-1], " Details: ", ts["Details"]
)

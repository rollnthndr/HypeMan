...
try:
    img = cv2.imread(CFG.GREENIEBOARD.IMAGE_BOARD, cv2.IMREAD_COLOR)
...
bg = cv2.imread(CFG.GREENIEBOARD.IMAGE_BOARDROOM)
...
fg = cv2.imread(CFG.GREENIEBOARD.IMAGE_BOARDROOM_MASK, 0)
...
cv2.imwrite(CFG.GREENIEBOARD.IMAGE_BOARDROOM_FINAL, final)
